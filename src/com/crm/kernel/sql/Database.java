...
//	    configProvider.loadFromFile("C://ServerConfig.txt");
	    configProvider.loadFromFile(WSConfiguration.configPath
		    + "ServerConfig.txt");

	    appDatasource.setMinPoolSize(configProvider.getInteger(
		    "minPoolSize", 10));
	    appDatasource.setMaxPoolSize(configProvider.getInteger(
		    "maxPoolSize", 30));
	    appDatasource.setAcquireIncrement(configProvider.getInteger(
		    "acquireIncrement", 5));

	    appDatasource.setNumHelperThreads(configProvider.getInteger(
		    "numHelperThreads", 1));
	    appDatasource.setMaxIdleTime(configProvider.getInteger(
		    "maxIdleTime", 300));
	    appDatasource.setIdleConnectionTestPeriod(configProvider
		    .getInteger("idleConnectionTestPeriod", 30));

	    appDatasource.setPreferredTestQuery(configProvider.getString(
		    "preferredTestQuery", "Select * From dual"));
	    appDatasource.setTestConnectionOnCheckout(configProvider
		    .getBoolean("testConnectionOnCheckout", true));
	    appDatasource.setTestConnectionOnCheckin(configProvider.getBoolean(
		    "testConnectionOnCheckin", true));

	    appDatasource.setDriverClass(configProvider.getString(
		    "database.driver", "oracle.jdbc.driver.OracleDriver"));
	    appDatasource.setJdbcUrl(configProvider.getString("DBUrl",
		    "jdbc:oracle:thin:@localhost:1521:CRM"));
	    appDatasource.setUser(configProvider.getString("UserName",
		    "ccs_owner"));
	    appDatasource.setPassword(configProvider.getString("Password",
		    "ccs_owner"));
     ...
     */
    // ///////////////////////////////////////////////////////////////
    public static Connection getConnection(String strUrl, String strUserName,
	    String strPassword) throws AppException {
	return getConnection("oracle.jdbc.driver.OracleDriver", strUrl,
     ...
     */
    // ///////////////////////////////////////////////////////////////
    public static Connection getConnection(String strDriver, String strUrl,
	    String strUserName, String strPassword) throws AppException {
	try {
